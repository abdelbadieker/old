  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
        ...
        <a href="#" className="btn-secondary" style={{ padding: '8px 16px', fontSize: 13, borderRadius: 8, display: 'flex', alignItems: 'center', gap: 6, textDecoration: 'none', background: 'rgba(255,255,255,.05)', border: '1px solid var(--border-c)' }}>
          <span style={{ color: '#10B981' }}>📊</span> View Google Sheet
        </a>
      </div>
