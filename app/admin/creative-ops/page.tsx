...
const initialColumns = {
  script: { title: '📝 Script', color: '#F59E0B', items: [{ id: 'c1', title: 'Reel — Summer Collection', client: 'Store DZ' }] },
  shoot: { title: '📸 Shoot', color: '#7C3AED', items: [{ id: 'c2', title: 'Product Showcase x3', client: 'AlgerShop' }] },
  edit: { title: '✂️ Edit', color: '#3B82F6', items: [] as KanbanItem[] },
  delivered: { title: '✅ Delivered', color: '#10B981', items: [] as KanbanItem[] },
}
